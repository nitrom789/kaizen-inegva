export const translations = {
  ...
  ru: {    
    ...
    categorySavings: "Экономия",
    categoryConvenience: "Удобство",
  ...
  ua: {
    ...
    categorySpeed: "Швидкість",
    categorySavings: "Економія",
    categoryConvenience: "Зручність",
